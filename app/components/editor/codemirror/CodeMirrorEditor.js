...
export const CodeMirrorEditor = memo(({ id, doc, debounceScroll = 100, debounceChange = 150, autoFocusOnDocumentChange = false, editable = true, onScroll, onChange, onSave, theme, settings, className = '', }) => {
    ...
    return (_jsxs("div", { className: classNames('relative h-full', className), children: [doc?.isBinary && _jsx(BinaryContent, {}), _jsx("div", { className: "h-full overflow-hidden", ref: containerRef })] }));
});
